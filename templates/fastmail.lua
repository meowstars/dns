function fastmail(domain)
  -- Allows you to receive email at standard addresses, e.g. user@skywrathmage.com
  mx(domain, "in1-smtp.messagingengine.com", 10)
  mx(domain, "in2-smtp.messagingengine.com", 20)

  -- Allows you to receive email at subdomain addresses, e.g. foo@user.skywrathmage.com
  mx(concat("*", domain), "in1-smtp.messagingengine.com", 10)
  mx(concat("*", domain), "in2-smtp.messagingengine.com", 20)

  -- Allows you to log in to your account at http://mail.skywrathmage.com.
  ...
  -- to allow receiving email addressed to foo@mail.skywrathmage.com
  ...
  txt(concat("_dmarc", domain), '"v=DMARC1; p=none; adkim=s; aspf=r; fo=1; rua=mailto:postmaster@' .. domain .. '"')
